...
public class StringUtil {
	...
	* 使用场景：网页文本框传到后台的字符串就可能就会回车换行。*/
	 ...
	 */
	/*
	 * public static String toHtml(String src) { String str =
	 * src.replaceAll(System.getProperty("line.separator"),"|"); String[] split =
	 * str.split("\\|"); String newStr = ""; for (String string : split) {
	 * newStr+="<p>"+string+"</p>"; } return newStr; }
	 */
	...
	public static String randomSimpleChinese() {
		...
		return (char)(random.nextInt(40869-19968+1)+19968)+"";
	}
